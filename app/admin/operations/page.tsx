  ...
  return (
    <AdminLayout title={lang === "en" ? "Operations" : lang === "zh-CN" ? "运营中心" : "營運中心"} subtitle={lang === "en" ? "Monitor business flow" : lang === "zh-CN" ? "监控业务流程" : "監控業務流程"}>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard label={lang === "en" ? "Pending" : lang === "zh-CN" ? "待处理" : "待處理"} value={formatNumber(orders.filter((o) => (o.status as any) === "pending" || (o.status as any) === "pending_payment").length)} icon={Activity} accent="rose" />
      </div>
